...
@Controller
public class MessageController_old {
    private static final Logger logger = LoggerFactory.getLogger(MessageController_old.class);
    ...
    public MessageController_old(DBServiceClient dbServiceClient) {
